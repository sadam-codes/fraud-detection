  ...
  return (
    <div className="flex min-h-[calc(100svh-12rem)] flex-col items-center justify-center py-8">
      <div className="w-full max-w-md">
        <p className="text-center text-sm font-semibold uppercase tracking-wider text-indigo-600">Get started</p>
        <h1 className="mt-2 text-center text-3xl font-bold text-slate-900">Create account</h1>
          ...
          <form onSubmit={onSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                className="mt-1.5 w-full rounded-xl border border-slate-200 bg-slate-50/50 px-4 py-3 text-slate-900 outline-none transition focus:border-indigo-400 focus:bg-white focus:ring-2 focus:ring-indigo-500/20"
              />
            </div>
            <div>
